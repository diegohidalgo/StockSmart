...
public class UpdateProductCommandHandler(
    ...
    ILoggerFactory loggerFactory) : ICommandHandler<UpdateProductCommand, IEnumerable<ProductResponse>>
{
    ...
    private readonly ILogger _logger = loggerFactory.CreateLogger<UpdateProductCommandHandler>();
